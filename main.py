...
print(78, translit(num2words(78, to='cardinal'), 'ru'), sep=' - ')
print(15, translit(num2words(15, to='cardinal'), 'ru'), sep=' - ')
print(3, translit(num2words(3, to='cardinal'), 'ru'), sep=' - ')
print(40, translit(num2words(40, to='cardinal'), 'ru'), sep=' - ')
print(8, translit(num2words(8, to='cardinal'), 'ru'), sep=' - ')